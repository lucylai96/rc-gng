...
Q4(:,:,1) = [0.2 0.8; 0.8 0.2; 0.19 0.81; 0.81 0.19];  % S = 4, high similarity, distance is 0

Q4(:,:,2) = [0.2 0.8; 0.8 0.2; 0.3 0.7; 0.7 0.3];  % S = 4, med similarity, LC, distance is 0.1

Q4(:,:,3) = [0.2 0.8; 0.8 0.2; 0.1 0.9; 0.9 0.1];  % S = 4, med similarity, HC, distance is 0.1

Q4(:,:,4) = [0.2 0.8; 0.8 0.2; 0.4 0.6; 0.6 0.4];  % S = 4, low similarity, LC, distance is 0.2

Q4(:,:,5) = [0.2 0.8; 0.8 0.2; 0 1; 1 0];          % S = 4, low similarity, HC, distance is 0.2
